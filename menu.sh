...
function installHyperland() {
	...
	! dpkg -s meson >/dev/null 2>&1 && sudo apt install meson -y
	! dpkg -s wget >/dev/null 2>&1 && sudo apt install wget -y
	! dpkg -s build-essential >/dev/null 2>&1 && sudo apt install build-essential -y
	! dpkg -s ninja-build >/dev/null 2>&1 && sudo apt install ninja-build -y
	! dpkg -s cmake-extras >/dev/null 2>&1 && sudo apt install cmake-extras -y
	! dpkg -s cmake >/dev/null 2>&1 && sudo apt install cmake -y
	! dpkg -s gettext >/dev/null 2>&1 && sudo apt install gettext -y
	! dpkg -s gettext-base >/dev/null 2>&1 && sudo apt install gettext-base -y
	! dpkg -s fontconfig >/dev/null 2>&1 && sudo apt install fontconfig -y
	! dpkg -s libfontconfig-dev >/dev/null 2>&1 && sudo apt install libfontconfig-dev -y
	! dpkg -s libffi-dev >/dev/null 2>&1 && sudo apt install libffi-dev -y
	! dpkg -s libxml2-dev >/dev/null 2>&1 && sudo apt install libxml2-dev -y
	! dpkg -s libdrm-dev >/dev/null 2>&1 && sudo apt install libdrm-dev -y
	! dpkg -s libxkbcommon-x11-dev 2>&1 && sudo apt install libxkbcommon-x11-dev -y
	! dpkg -s libxkbregistry-dev >/dev/null 2>&1 && sudo apt install libxkbregistry-dev -y
	! dpkg -s libxkbcommon-dev >/dev/null 2>&1 && sudo apt install libxkbcommon-dev -y
	! dpkg -s libpixman-1-dev >/dev/null 2>&1 && sudo apt install libpixman-1-dev -y
	! dpkg -s libudev-dev >/dev/null 2>&1 && sudo apt install libudev-dev -y
	! dpkg -s libseat-dev >/dev/null 2>&1 && sudo apt install libseat-dev -y
	! dpkg -s seatd >/dev/null 2>&1 && sudo apt install seatd -y
	! dpkg -s libxcb-dri3-dev >/dev/null 2>&1 && sudo apt install libxcb-dri3-dev -y
	! dpkg -s libegl-dev >/dev/null 2>&1 && sudo apt install libegl-dev -y
	! dpkg -s libgles2 >/dev/null 2>&1 && sudo apt install libgles2 -y
	! dpkg -s libegl1-mesa-dev >/dev/null 2>&1 && sudo apt install libegl1-mesa-dev -y
	! dpkg -s glslang-tools >/dev/null 2>&1 && sudo apt install glslang-tools -y
	! dpkg -s libinput-bin >/dev/null 2>&1 && sudo apt install libinput-bin -y
	! dpkg -s libinput-dev >/dev/null 2>&1 && sudo apt install libinput-dev -y
	! dpkg -s libxcb-composite0-dev >/dev/null 2>&1 && sudo apt install libxcb-composite0-dev -y
	! dpkg -s libavutil-dev >/dev/null 2>&1 && sudo apt install libavutil-dev -y
	! dpkg -s libavcodec-dev >/dev/null 2>&1 && sudo apt install libavcodec-dev -y
	! dpkg -s libavformat-dev >/dev/null 2>&1 && sudo apt install libavformat-dev -y
	! dpkg -s libxcb-ewmh2 >/dev/null 2>&1 && sudo apt install libxcb-ewmh2 -y
	! dpkg -s libxcb-ewmh-dev >/dev/null 2>&1 && sudo apt install libxcb-ewmh-dev -y
	! dpkg -s libxcb-present-dev >/dev/null 2>&1 && sudo apt install libxcb-present-dev -y
	! dpkg -s libxcb-icccm4-dev >/dev/null 2>&1 && sudo apt install libxcb-icccm4-dev -y
	! dpkg -s libxcb-render-util0-dev >/dev/null 2>&1 && sudo apt install libxcb-render-util0-dev -y
	! dpkg -s libxcb-res0-dev >/dev/null 2>&1 && sudo apt install libxcb-res0-dev -y
	! dpkg -s libxcb-xinput-dev >/dev/null 2>&1 && sudo apt install libxcb-xinput-dev -y
	! dpkg -s libtomlplusplus3 >/dev/null 2>&1 && sudo apt install libtomlplusplus3 -y
